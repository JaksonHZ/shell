...
//Captura o sinal do filho e espera ele terminar com waitpid, OBS: WNOHANG(opcao para esperar terminar todos os processos filhos)
...
int main() {
    ...
    // Configura o tratador de sinal SIGCHLD como a funcao handle_sigchld, tratando assim os zombies
